...
- [Xyph Gate Alpha demo plan](reference/xyph-gate-alpha-demo-plan.md) - cross-repo demo spine, goalposts, fixture vocabulary, and milestone order for the Xyph Gate Alpha campaign.
