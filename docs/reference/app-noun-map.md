...
title: App Noun Map
status: current
audiences: [maintainer, agent, app-author]
intents: [look-up-a-term]
---

# App Noun Map

This page freezes the app-to-WARP noun map across the active Continuum stack.
...
[Shared Noun Glossary](glossary.md); this page adds the per-app mapping
(notably `jedit`'s) on top of it.
